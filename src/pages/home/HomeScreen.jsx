...
const HomeScreen= () => {
    ...
    return (
        ...
        {imgLoading && (
            <div className='absolute top-0 left-0 w-full h-full bg-black/70 flex items-center shimmer -z-10'/>
        )}
...
<div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
    ...
    <div className='max-w-2xl'>
        ...
        <p className='mt-4 text-lg'>
            {trendingContent?.overview ? (trendingContent.overview.length > 200 
    ...
    <div className='flex mt-8'>
        ...
        <Play classNmae='size-6 inline-block mr-2 fill-black'/>
        Play
        </Link>

        <Link to={`/watch/${trendingContent?.id}`}
        className='bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded flex items-center'>
        <Info classNmae='size-6 inline-block mr-2 '/>
        More Info
        </Link>
    </div>
</div>
